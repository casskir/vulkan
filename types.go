...
type DebugReportCallbackFunc func(flags DebugReportFlags, objectType DebugReportObjectType, object uint64, location uint64, messageCode int32, pLayerPrefix []byte, pMessage []byte, pUserData unsafe.Pointer) Bool32
