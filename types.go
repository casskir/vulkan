...
type PhysicalDeviceVulkan12Properties struct {
	...
	MaxTimelineSemaphoreValueDifference                  uint
...
type TimelineSemaphoreSubmitInfo struct {
	...
	PWaitSemaphoreValues      []uint
	SignalSemaphoreValueCount uint32
	PSignalSemaphoreValues    []uint
...
type FormatFeatureFlagBits2 uint
...
type DebugReportCallbackFunc func(flags DebugReportFlags, objectType DebugReportObjectType, object uint, location uint, messageCode int32, pLayerPrefix string, pMessage string, pUserData unsafe.Pointer) Bool32
...
type PastPresentationTimingGOOGLE struct {
	PresentID           uint32
	DesiredPresentTime  uint
	ActualPresentTime   uint
	EarliestPresentTime uint
	PresentMargin       uint
